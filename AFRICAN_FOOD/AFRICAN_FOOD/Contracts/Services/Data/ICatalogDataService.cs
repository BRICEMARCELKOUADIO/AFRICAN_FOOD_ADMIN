...
namespace AFRICAN_FOOD.Contracts.Services.Data
{
    public interface ICatalogDataService
    {
        ...
        Task<Pie> AddPiesAsync(int pieId, string name, string shortDescription, decimal price, decimal prixPromotionnel, string imageToBase64, /*byte[] image,*/ bool isPieOfTheWeek, bool inStock, string userAdminId, string userPhone, double longitude, double latitude, string positionGeo, bool isModify, int quantite);
